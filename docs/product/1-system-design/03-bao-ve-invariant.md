...
| ~~**P1-08**~~ — realtime, đường kéo dự phòng, ràng buộc ẩn — **xong 2026-09-08** | cơ chế **phát hiện** quán đang mất kết nối (input cho điều kiện thứ ba của `I-008`) đã có nhà: [`05-realtime-va-du-phong.md`](05-realtime-va-du-phong.md) §3 — bốn câu luật. **`U-043` đã đóng 2026-09-16**: không có *độ dài cửa sổ* nào, máy **báo** còn **POS quyết** dừng, mở lại bằng nút (**ADR-047**); chỗ để ngỏ nay là ca quán **mất mạng hẳn** — `U-053`. §3 ở đây vẫn chỉ nói máy phải chặn đúng ba kênh khi đã biết |
