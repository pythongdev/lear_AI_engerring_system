...
| 11 | **Mất mạng trong lúc quán đang phục vụ** | Cả quán chuyển cách làm; *người đứng quầy* giữ sổ (`shop-facts.md` §6.11) | **Không dừng bán.** Đơn và phiên vẫn chạy đúng các trạng thái §5, nhưng ghi **trên sổ giấy** thay vì trên máy. **Ba kênh khách tự bấm DỪNG** — `delivery`, `pickup`, `qr_table` không tạo được đơn nào, và web hiện **một dòng thông báo**; khách đặt qua **hotline**, quán ghi giấy trực tiếp với POS (chủ quán chốt 2026-09-04, đóng **U-035**; `shop-facts.md` §6.11, **I-008**) | Thu bình thường, ghi sổ. Phần ghi tay phải nhập lại để đối soát cuối ngày còn đọc được (§4.9), và **doanh thu của nó tính vào ngày quán BÁN**, không phải ngày gõ vào máy (chủ quán chốt 2026-09-04, đóng **U-032**; `shop-facts.md` §6.11, **ADR-037**) ⇒ ngày còn lượt chưa nhập là ngày **chưa đối soát xong** |
| 12 | **Mất điện hoặc thiết bị POS gặp sự cố** | Như dòng 11 (`shop-facts.md` §6.11) | Như dòng 11 — kể cả vế **ba kênh khách tự bấm dừng**, vì lý do giống hệt: quán không nhìn thấy đơn mới | Như dòng 11, kể cả vế **doanh thu tính ngày bán** |
...
**Hai dòng chốt thêm ngày 2026-09-04**, cùng một lần trả lời, và cả hai rơi vào **dòng 11–12**:

- **Quán mất kết nối ⇒ web ngừng nhận đơn** (đóng **U-035**) — khách đặt qua **hotline**, quán ghi
  giấy trực tiếp với POS, trên web có **một dòng thông báo**. ⇒ **Điều kiện thứ ba** để một đơn
  được tạo (`quality/invariants.md` **I-008**), và là điều kiện duy nhất **không ai bấm được**: nút
  *"Tạm dừng nhận đơn"* của dòng 6 nằm sau đúng đường mạng vừa mất. *Câu chữ của dòng thông báo
  **chưa** chốt — đừng tự viết.*
