...
| Đang giao | Nhân viên giao xong, bấm **đã giao** và **đã thu tiền** cùng lúc | **Hoàn thành** | *Nhân viên quán* đi giao (§3.2.2, `shop-facts.md` §6.7). *Mốc `Đã ra bàn` của từng việc trạm trong ca này vẫn do **người đứng quầy** bấm — chủ quán chốt 2026-09-04, đóng **U-031**; xem §5.4* |
...
- **ĐƠN GIAO TẬN NƠI KHÔNG PHẢI NGOẠI LỆ** (chủ quán chốt **2026-09-04**, trả lời U-031, nguyên
  văn *"pos"*). Câu trả lời ngày 2026-09-01 (U-021) **không nhắc tới** ca này, và ca này là ca duy
  nhất mà lúc suất tới tay khách người có mặt là *nhân viên quán* đi giao — chính người mà §5.2 và
  §3.2.2 giao cho hai nút *đã giao* + *đã thu tiền*. Hai mục của tài liệu này vì thế từng chỉ
  **hai người khác nhau** cho cùng nút *"đã ra bàn"*. Lời chốt 2026-09-04 khép chỗ ấy: **người
  đứng quầy bấm**, kể cả với đơn giao; người đi giao vẫn **không** bấm mốc nào của bảng bếp. ⇒ §5.5
  chạy được cho đơn giao, và không ai phải bấm khống một mốc cho suất đang ở nhà khách.
  *Vế **lúc nào** quầy bấm thì lời ấy không nói* — chỗ **suy ra** là **S-6** ở
  `master_plan/shop-facts.md` §7.2 (*lúc đơn rời quán*, cùng mốc sang `Đang giao`); đừng đọc nó
  thành lời chủ quán, và đừng dựng màn người đi giao như thể nó đã chốt (CLAUDE.md §3.5).
